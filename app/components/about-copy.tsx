  ...
  return (
    <div className="about-copy">
      ...
      <p>
        ...
        Vancouver, and Toronto. I have been in Toronto for uni, and am currently
        a master’s student at the Munk School of Global Affairs and Public Policy
        at the University of Toronto. I hope to write my thesis on the ways in
        which powerful people make decisions about the world—decisions that are
        often, if not most of the time, difficult to understand.
      </p>
      <p>
      ...
      <p>
        ...
        like to hear about it. Shoot me an email or connect with me on LinkedIn.
      </p>
